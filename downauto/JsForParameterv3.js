...
var ComparePageObject = {
    ...
    ArrSelectQf: new Array(),//驱动方式
    ArrSelectSeat: new Array(),
    ArrSelectEnergy: new Array(),//燃料类型
...
function goucheCallback() {
    ...
    $.ajax({
        url: "//api.gouche.yiche.com/PreferentialCar/GetCarListBySerialId?serialid=" + CarCommonCSID + "&cityid=" + zdjcityId + "", cache: true, dataType: "jsonp", jsonpCallback: "getCarList", success: function (data) {
...
function bindEvent() {
    ...
    $("#popup-box a[name='btnCorrectError']").click(function (e) {
        ...
        var url = "//www.bitauto.com/FeedBack/api/CommentNo.ashx?txtContent=" + encodeURIComponent(content) + "&satisfy=1&ProductId=5&categorytype=2&csid=" + (typeof (CarCommonCSID) != "undefined" ? CarCommonCSID : 0) + "&refer=//car.bitauto.com" + window.location.pathname;
        $.ajax({
...
function createPic() {
    ...
    ComparePageObject.FloatTop.push("<div class=\"check-box-item\" onclick=\"BglogPostLog('2.231.2447',this);\"><input type=\"checkbox\" name=\"chkAdvantage\" onclick=\"advantageForCompare();\" " + (ComparePageObject.IsVantage ? "checked" : "") + "> <label for=\"chkAdvantage\">标识优势项 <em></em></label></div>");
    ComparePageObject.FloatTop.push("<div class=\"check-box-item\" onclick=\"BglogPostLog('2.231.2446',this);\"><input type=\"checkbox\" name=\"checkboxForDiff\" onclick=\"showDiffForCompare();\" " + (ComparePageObject.IsShowDiff ? "checked" : "") + "> <label for=\"checkboxForDiff\">高亮不同项</label></div>");
    ComparePageObject.FloatTop.push("<div class=\"check-box-item\" onclick=\"BglogPostLog('2.231.2445',this);\"><input type=\"checkbox\" name=\"checkboxForDelTheSame\" onclick=\"delTheSameForCompare();\" > <label for=\"checkDiffer\">隐藏相同项</label></div>");
    ...
    ComparePageObject.FloatLeft.push("<div onclick=\"BglogPostLog('2.231.2447',this);\"  class=\"check-box-item\"><input  type=\"checkbox\" id=\"chkAdvantage\" name=\"chkAdvantage\" onclick=\"advantageForCompare();\" " + (ComparePageObject.IsVantage ? "checked" : "") + "> <label for=\"chkAdvantage\">标识优势项 <em></em></label></div>");
    ComparePageObject.FloatLeft.push("<div onclick=\"BglogPostLog('2.231.2446',this);\"  class=\"check-box-item\"><input type=\"checkbox\" name=\"checkboxForDiff\" onclick=\"showDiffForCompare();\" id=\"checkboxForDiff\" " + (ComparePageObject.IsShowDiff ? "checked" : "") + "> <label for=\"checkboxForDiff\">高亮不同项</label></div>");
    ComparePageObject.FloatLeft.push("<div onclick=\"BglogPostLog('2.231.2445',this);\"  class=\"check-box-item\"><input type=\"checkbox\" name=\"checkboxForDelTheSame\" onclick=\"delTheSameForCompare();\" id=\"checkDiffer\"> <label for=\"checkDiffer\">隐藏相同项</label></div>");
    ...
    ComparePageObject.ArrPageContent.push("<div onclick=\"BglogPostLog('2.231.2447',this);\" class=\"check-box-item\"><input type=\"checkbox\" name=\"chkAdvantage\" onclick=\"advantageForCompare();\" " + (ComparePageObject.IsVantage ? "checked" : "") + "> <label for=\"chkAdvantage\">标识优势项 <em></em></label></div>");
    ComparePageObject.ArrPageContent.push("<div onclick=\"BglogPostLog('2.231.2446',this);\" class=\"check-box-item\"><input type=\"checkbox\" name=\"checkboxForDiff\" onclick=\"showDiffForCompare();\" " + (ComparePageObject.IsShowDiff ? "checked" : "") + "> <label for=\"checkboxForDiff\">高亮不同项</label></div>");
    ComparePageObject.ArrPageContent.push("<div onclick=\"BglogPostLog('2.231.2445',this);\" class=\"check-box-item\"><input type=\"checkbox\" name=\"checkboxForDelTheSame\" onclick=\"delTheSameForCompare();\"> <label for=\"checkDiffer\">隐藏相同项</label></div>");
        ...
        if (checkCarIsShowForeach(i)) {
            if (ComparePageObject.ArrCarInfo[i].CarInfoArray) {
                ...
                try {
                    ...
                    ComparePageObject.ArrPageContent.push("<dd><a target=\"_blank\" data-channelid=\"2.231.2450\" href=\"/" + csAllSpell + "/m" + carid + "/\" title=\"" + (carYear == "" ? "" : "" + carYear + "款 ") + carName + "\">" + (carYear == "" ? "" : "" + carYear + "款 ") + carName + "</a></dd>");
                    if (referPrice != "无") {
                    ...
                    ComparePageObject.FloatTop.push("<dl><dd><a target=\"_blank\" onclick=\"BglogPostLog('2.231.2450',this);\" href=\"/" + csAllSpell + "/m" + carid + "/\" title=\"" + (carYear == "" ? "" : "" + carYear + "款 ") + carName + "\">" + (carYear == "" ? "" : "" + carYear + "款 ") + carName + "</a></dd>");
                    if (referPrice != "无") {
                    ...
                    if (ComparePageObject.IsNeedDrag) {
                        ...
                        var compareStr = "";
                        compareStr = "<div class=\"button_gray btn-compare-car\"><a title=\"对比\" data-channelid=\"2.231.2449\" data_cyslogclickflag=\"2.231.2449\" onclick=\"BglogPostLog('2.231.2449',this);\" href=\"javascript:;\" class=\"btn btn-xs\" data-use=\"compare\" data-id=\"" + carid + "\"><span>+对比</span></a></div>";
                        if (isShowLoop == 0) {
                            if (checkIsRightEnd(i)) {
                                ...
                                ComparePageObject.ArrPageContent.push(compareStr);
                                ComparePageObject.ArrPageContent.push("<span class=\"button_gray btn-next-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"右移\">></a></span>");
                                ComparePageObject.FloatTop.push(compareStr);
                                ComparePageObject.FloatTop.push("<span class=\"button_gray btn-next-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"右移\">></a></span>");
                            }
                        }
                        else {
                            if (checkIsRightEnd(i)) {
                                ComparePageObject.ArrPageContent.push("<span class=\"button_gray btn-pre-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"左移\"><</a></span>");
                                ComparePageObject.FloatTop.push("<span class=\"button_gray btn-pre-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"左移\"><</a></span>");
                                ComparePageObject.ArrPageContent.push(compareStr);
                                ComparePageObject.FloatTop.push(compareStr);
                            }
                            else {
                                ComparePageObject.ArrPageContent.push("<span class=\"button_gray btn-pre-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"左移\"><</a></span>" + compareStr + "<span class=\"button_gray btn-next-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"右移\">></a></span>");
                                ComparePageObject.FloatTop.push("<span class=\"button_gray btn-pre-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\"  title=\"左移\"><</a></span>" + compareStr + "<span class=\"button_gray btn-next-car\"><a href=\"javascript:;\" data-channelid=\"2.231.2451\" data_cyslogclickflag=\"2.231.2451\" onclick=\"BglogPostLog('2.231.2451',this);\" title=\"右移\">></a></span>");
                            }
                        }
                    }
                    ComparePageObject.ArrPageContent.push("</div>");
                    ComparePageObject.ArrPageContent.push("</div>");
                    ComparePageObject.ArrPageContent.push("<a class=\"btn-close-car\" title=\"删除\" href=\"javascript:;\" data-channelid=\"2.231.2448\" data_cyslogclickflag=\"2.231.2448\"  onclick=\"delCarToCompare('" + i + "',event);BglogPostLog('2.231.2448',this);\">删除</a>");
                    // for FloatTop
                    ComparePageObject.FloatTop.push("</div></div>");
                    ComparePageObject.FloatTop.push("<a class=\"btn-close-car\" title=\"删除\" href=\"javascript:;\" data-channelid=\"2.231.2448\" data_cyslogclickflag=\"2.231.2448\"  onclick=\"delCarToCompare('" + i + "',event);BglogPostLog('2.231.2448',this);\">删除</a>");
            ...
            if (ComparePageObject.ArrCarInfo[i].CarInfoArray) {
                ...
                if (field.length < 1 || field == "无") {
                    ...
                    if (arrFieldRow["sFieldTitle"] == "商家报价") {
                        ...
                        ComparePageObject.ArrPageContent.push("<span class=\"cRed\"><a target=\"_blank\" href=\"//price.bitauto.com/car.aspx?newcarid=" + ComparePageObject.ArrCarInfo[i].CarID + "&citycode=0&leads_source=p042003\">" + fieldTemp + "</a></span>");
                        ComparePageObject.ArrPageContent.push("<div class=\"button_gray button_43_20\"><a target=\"_blank\" onclick=\"BglogPostLog('2.231.2452',this);\" href=\"//dealer.bitauto.com/zuidijia/nb" + (ComparePageObject.ArrCarInfo[i].CarInfoArray[0][3] || "") + "/nc" + ComparePageObject.ArrCarInfo[i].CarID + "/?leads_source=p042001\">询价</a></div>");
                        ComparePageObject.ArrPageContent.push("</div>");
                    }
                    else if (arrFieldRow["sFieldTitle"] == "降价优惠") {
                        var csAllSpell = ComparePageObject.ArrCarInfo[i].CarInfoArray[0][6] || "";
                        ComparePageObject.ArrPageContent.push("<span class=\"tdJiangjia\"><a target=\"_blank\" href=\"//car.bitauto.com/" + csAllSpell + "/m" + ComparePageObject.ArrCarInfo[i].CarID + "/jiangjia/\">" + field + "</a></span>");
                    }
                    else { }
                }
...
function createPara(arrFieldRow) {
            ...
            if (ComparePageObject.ArrCarInfo[i].CarInfoArray) {
                ...
                try {
                    ...
                    if (arrFieldRow["sFieldTitle"] == "厂商指导价" && field != "无" && field != "待查") {
                        ...
                        arrTemp.push("<a class=\"icon_cal\" title=\"购车费用计算\" href=\"//car.bitauto.com/gouchejisuanqi/?carid=" + ComparePageObject.AllCarJson[i][0][0] + "\" onclick=\"BglogPostLog('2.231.2453',this);\" target=\"_blank\"></a>");
                    ...
                    else if (arrFieldRow["sFieldTitle"] == "外观颜色" && field != "") {
    ...
    if (firstSame && ComparePageObject.IsDelSame && isShowLoop > 1) {
        ...
        if (!isAllunknown) {
            ComparePageObject.ArrPageContent.push("<tr" + (arrFieldRow["sFieldTitle"] == "外观颜色" ? " class=\"p-color" + (colorRow <= 1 ? "" : (" h" + parseInt(colorRow) * 30)) + "\"" : (arrFieldRow["sFieldTitle"] == "音响品牌" ? " class=\"h36\"" : "")) + ">");
                ...
                try {
                    ...
                    for (var pint = 0; pint < paramArray.length; pint++) {
                        ...
                        if (field.length > 0) {
                            ...
                            else if (pidArray[pint] == "879") {
                                field = "慢充" + field + unitArray[pint] || "";
                            }
                            else if (pidArray[pint] == "785") {
                                if (ComparePageObject.ArrCarInfo[i].CarInfoArray[prefixArray[3]][9].indexOf("增压") > -1) {
                                    field = field + "T ";
                                }
                                else {
                                    field = field + "L ";
    ...
    for (var i = 0; i < ComparePageObject.ValidCount; i++) {
        ...
        if (checkCarIsShowForeach(i)) {
            ...
            if (!ComparePageObject.ArrCarInfo[i].CarInfoArray) {
                ...
                //optionalJson:{text:"后方影像",price:0}
                var standardJson = [],
                    optionalJson = [],
                    standardStrLength = 0;
                ...
                if (optionalJson.length > 0) {
                    for (var optIndex = 0; optIndex < optionalJson.length; optIndex++) {
                        ...
                        if (optionalJson[optIndex].price != "0") {
        ...
        for (var i = 0; i < ComparePageObject.ValidCount; i++) {
            if (checkCarIsShowForeach(i)) {
                ...
                if (optionalPackageJson[opt].carid.contains(ComparePageObject.ArrCarInfo[i].CarID)) {
                    arrTemp.push("<td name=\"td" + i + "\"><span>○ 选配" + formatCurrency(optionalPackageJson[opt].price) + "元</span></td>");
                }
                else {
...
function createBar(arrFieldRow) {
    ...
    ComparePageObject.ArrTempBarForFloatLeftHTML.push("</tr>");
    //左侧菜单数据
    ComparePageObject.ArrTempLeftNavHTML.push("<li data-channelid=\"" + GetBuriedPoint(arrFieldRow["sFieldTitle"]) + "\" class=\"" + (arrFieldRow["sFieldTitle"] == "基本信息" ? "current" : "") + "\"><a data-target=\"" + arrFieldRow["scrollId"] + "\" href=\"javascript:;\" title1=\"" + arrFieldRow["sFieldTitle"] + "\"  >" + arrFieldRow["sFieldTitle"] + "<i></i></a></li>");
}
//获得埋点
function GetBuriedPoint(groupName) {
    switch (groupName) {
        case "信息娱乐":
            return "2.231.2463";
        case "座椅配置":
...
function setExhaustAndTransmissionType() {
    ...
    var arrTempQf = new Array();
    var arrQf = new Array();
    var qf = "";

    var arrTempSeats = new Array();
    var arrSeats = new Array();
    var seats = "";

    var arrTempEnergy = new Array();
    ...
    for (var i = 0; i < ComparePageObject.ValidCount; i++) {
        ...
        //驱动方式
        if (ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0] != "") {
            if (qf.indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0] + ",") < 0) {
                qf += ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0] + ",";
                arrTempQf.push(ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0]);
            }
        }
        //座位数
        if (ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5] != "") {
            if (seats.indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5] + ",") < 0) {
                seats += ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5] + ",";
                arrTempSeats.push(ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5]);
            }
        }
        //燃料类型
        if (ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14] != "") {
            if (energy.indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14] + ",") < 0) {
                energy += ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14] + ",";
                arrTempEnergy.push(ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14]);
            }
        }
    }
    if (arrTempQf.length > 0) {
        for (var i = 0; i < arrTempQf.length; i++) {
            arrQf.push("<input type=\"checkbox\" id=\"checkboxQf_" + arrTempQf[i] + "\" value=\"" + arrTempQf[i] + "\" onclick=\"checkQf(this);\" >");
            arrQf.push("<label for=\"checkboxQf_" + arrTempQf[i] + "\">" + arrTempQf[i] + "</label>");
        }
    }
    if (arrTempSeats.length > 0) {
        for (var i = 0; i < arrTempSeats.length; i++) {
            arrSeats.push("<input type=\"checkbox\" id=\"checkboxSeat_" + arrTempSeats[i] + "\" value=\"" + arrTempSeats[i] + "\" onclick=\"checkSeat(this);\" >");
            arrSeats.push("<label for=\"checkboxSeat_" + arrTempSeats[i] + "\">" + arrTempSeats[i] + "座</label>");
        }
    }
    if (arrTempEnergy.length > 0) {
        for (var i = 0; i < arrTempEnergy.length; i++) {
            arrEnergy.push("<input type=\"checkbox\" id=\"checkboxEnergy_" + arrTempEnergy[i] + "\" value=\"" + arrTempEnergy[i] + "\" onclick=\"checkEnergy(this);\" >");
            arrEnergy.push("<label for=\"checkboxEnergy_" + arrTempEnergy[i] + "\">" + arrTempEnergy[i] + "</label>");
        }
    }
    // 排量排序
    ...
    if (arrExhaust.length > 0) {
        if (IsDistinct(arrTempExhaust)) {
            //exW = $("#spanFilterForEE").html("排量：" + arrExhaust.join("")).width() + 20;
            $("#spanFilterForEE").show();
            $("#spanFilterForEE").html("发动机：" + arrExhaust.join(""));
        }
    }
    if (arrTransmissionType.length > 0) {
        if (IsDistinct(arrTempTransmissionType)) {
            //trW = $("#spanFilterForTT").html("变速箱：" + arrTransmissionType.join("")).width() + 50;
            $("#spanFilterForTT").show();
            $("#spanFilterForTT").html("变速箱：" + arrTransmissionType.join(""));
        }

    }
    if (arrYear.length > 0) {
        if (IsDistinct(arrTempYear)) {
            //		if ($("#divFilter").width() - exW - trW - ((13 + 36) * arrYear.length + 42 + 50) > 0) {
            //			$("#spanFilterForYear").html("年款：" + arrYear.join(""));
            //		}
            $("#spanFilterForYear").show();
            $("#spanFilterForYear").html("年款：" + arrYear.join(""));
        }
    }
    if (arrQf.length > 0) {
        if (IsDistinct(arrTempQf)) {
            $("#spanFilterForQF").show();
            $("#spanFilterForQF").html("驱动方式：" + arrQf.join(""));
        }
    }
    if (arrSeats.length > 0) {
        if (IsDistinct(arrTempSeats)) {
            $("#spanFilterForSeats").show();
            $("#spanFilterForSeats").html("座位数：" + arrSeats.join(""));
        }
    }
    if (arrEnergy.length > 0) {
        if (IsDistinct(arrTempEnergy)) {
            $("#spanFilterForEnergy").show();
            $("#spanFilterForEnergy").html("燃料类型：" + arrEnergy.join(""));
        }
    }
}
//判断数组中元素是否都相同 有不相同的返回true
...
function checkQf(obj) {
    if (obj.checked) {
        if ((ComparePageObject.ArrSelectQf.join(",") + ",").indexOf(obj.value.toString()) < 0) {
            ComparePageObject.ArrSelectQf.push(obj.value.toString());
        }
    }
    else {
        if ((ComparePageObject.ArrSelectQf.join(",") + ",").indexOf(obj.value.toString()) >= 0) {
            for (var i = 0; i < ComparePageObject.ArrSelectQf.length; i++) {
                if (ComparePageObject.ArrSelectQf[i] == obj.value.toString()) {
                    ComparePageObject.ArrSelectQf.splice(i, 1);
                }
            }
        }
    }
...
function checkSeat(obj) {
    if (obj.checked) {
        if ((ComparePageObject.ArrSelectSeat.join(",") + ",").indexOf(obj.value.toString()) < 0) {
            ComparePageObject.ArrSelectSeat.push(obj.value.toString());
        }
    }
    else {
        if ((ComparePageObject.ArrSelectSeat.join(",") + ",").indexOf(obj.value.toString()) >= 0) {
            for (var i = 0; i < ComparePageObject.ArrSelectSeat.length; i++) {
                if (ComparePageObject.ArrSelectSeat[i] == obj.value.toString()) {
                    ComparePageObject.ArrSelectSeat.splice(i, 1);
                }
            }
        }
    }
...
function checkEnergy(obj) {
    if (obj.checked) {
        if ((ComparePageObject.ArrSelectEnergy.join(",") + ",").indexOf(obj.value.toString()) < 0) {
            ComparePageObject.ArrSelectEnergy.push(obj.value.toString());
        }
    }
    else {
        if ((ComparePageObject.ArrSelectEnergy.join(",") + ",").indexOf(obj.value.toString()) >= 0) {
            for (var i = 0; i < ComparePageObject.ArrSelectEnergy.length; i++) {
                if (ComparePageObject.ArrSelectEnergy[i] == obj.value.toString()) {
                    ComparePageObject.ArrSelectEnergy.splice(i, 1);
                }
            }
        }
    }
...
function resetSelectCarsByCheckbox() {
    if (ComparePageObject.ArrSelectExhaust.length > 0 || ComparePageObject.ArrSelectTransmission.length > 0 || ComparePageObject.ArrSelectYearType.length > 0
        || ComparePageObject.ArrSelectPower.length > 0 || ComparePageObject.ArrSelectQf.length > 0 || ComparePageObject.ArrSelectSeat.length > 0 || ComparePageObject.ArrSelectEnergy.length > 0) {
        for (var i = 0; i < ComparePageObject.ValidCount; i++) {
            ...
            if (ComparePageObject.ArrSelectQf.length > 0) {
                if (!ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0]) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
                if ((ComparePageObject.ArrSelectQf.join(",") + ",").indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[4][0] + ",") < 0) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
            }

            if (ComparePageObject.ArrSelectSeat.length > 0) {
                if (!ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5]) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
                if ((ComparePageObject.ArrSelectSeat.join(",") + ",").indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[2][5] + ",") < 0) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
            }

            if (ComparePageObject.ArrSelectEnergy.length > 0) {
                if (!ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14]) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
                if ((ComparePageObject.ArrSelectEnergy.join(",") + ",").indexOf(ComparePageObject.ArrCarInfo[i].CarInfoArray[1][14] + ",") < 0) {
                    ComparePageObject.ArrCarInfo[i].IsDel = true;
                    continue;
                }
            }
...
var arrField = [
    ...
    { sFieldTitle: "上市时间", sType: "fieldMulti", sPid: "385,384,383", sTrPrefix: "1,1,1", sFieldIndex: "12,11,10", unit: "/,/", joinCode: "" },
    { sFieldTitle: "车型级别", sType: "fieldPara", sPid: "", sTrPrefix: "0", sFieldIndex: "12", unit: "", joinCode: "" },
    { sFieldTitle: "车身型式", sType: "fieldPara", sPid: "574", sTrPrefix: "1", sFieldIndex: "13", unit: "", joinCode: "" },
    { sFieldTitle: "动力类型", sType: "fieldPara", sPid: "578", sTrPrefix: "1", sFieldIndex: "14", unit: "", joinCode: "" },
    { sFieldTitle: "发动机", sType: "fieldMulti", sPid: "785,418,417,425", sTrPrefix: "3,3,3,3", sFieldIndex: "1,7,8,9", unit: "L ,,缸 ,", joinCode: "" },
    { sFieldTitle: "最大功率/最大扭矩", sType: "fieldMulti", sPid: "430,429", sTrPrefix: "3,3", sFieldIndex: "2,5", unit: "kW,N.m", joinCode: ",/" },
    { sFieldTitle: "电动机总功率/总扭矩", sType: "fieldMulti", sPid: "870,872", sTrPrefix: "3,3", sFieldIndex: "20,21", unit: "kW,N.m", joinCode: ",/" },
    ...
    { sFieldTitle: "NEDC最大续航里程[km]", sType: "fieldPara", sPid: "883", sTrPrefix: "3", sFieldIndex: "30", unit: "", joinCode: "", isVantage: "1", size: "1" },
    { sFieldTitle: "电池充电时间", sType: "fieldMulti", sPid: "878,879", sTrPrefix: "3,3", sFieldIndex: "28,27", unit: "h,h", joinCode: "" },
    ...
    { sFieldTitle: "电池保修政策", sType: "fieldPara", sPid: "1006", sTrPrefix: "3", sFieldIndex: "31", unit: "", joinCode: "" },
    { sFieldTitle: "新能源汽车国家补贴[万]", sType: "fieldPara", sPid: "997", sTrPrefix: "2", sFieldIndex: "21", unit: "", joinCode: "" },
    { sFieldTitle: "外观颜色", sType: "fieldPara", sPid: "598", sTrPrefix: "0", sFieldIndex: "13", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "排量", sType: "fieldPara", sPid: "423", sTrPrefix: "3", sFieldIndex: "0", unit: "mL", joinCode: "" },
    ...
    { sFieldTitle: "制动辅助(BA/EBA等)", sType: "fieldPara", sPid: "684", sTrPrefix: "5", sFieldIndex: "2", unit: "", joinCode: "" },
    { sFieldTitle: "牵引力控制(ASR/TCS等)", sType: "fieldPara", sPid: "698", sTrPrefix: "5", sFieldIndex: "3", unit: "", joinCode: "" },
    { sFieldTitle: "车身稳定控制(ESP/DSC等)", sType: "fieldPara", sTrPrefix: "5", sPid: "700", sFieldIndex: "4", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "后排儿童座椅接口", sType: "fieldPara", sPid: "495", sTrPrefix: "5", sFieldIndex: "15", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "流媒体内后视镜", sType: "fieldPara", sPid: "1041", sTrPrefix: "7", sFieldIndex: "26", unit: "", joinCode: "" },
    { sFieldTitle: "流媒体外后视镜", sType: "fieldPara", sPid: "1045", sTrPrefix: "7", sFieldIndex: "27", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "主动降噪", sType: "fieldPara", sPid: "1043", sTrPrefix: "8", sFieldIndex: "13", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "液晶屏尺寸", sType: "fieldMultiValue", sPid: "1042", sTrPrefix: "10", sFieldIndex: "18", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "紧急道路救援", sType: "fieldPara", sPid: "1033", sTrPrefix: "10", sFieldIndex: "5", unit: "", joinCode: "" },
    { sFieldTitle: "4G网络", sType: "fieldPara", sPid: "1047", sTrPrefix: "10", sFieldIndex: "20", unit: "", joinCode: "" },
    { sFieldTitle: "车载APP应用", sType: "fieldPara", sPid: "1046", sTrPrefix: "10", sFieldIndex: "21", unit: "", joinCode: "" },
    { sFieldTitle: "语音控制", sType: "fieldMultiValue", sPid: "1035", sTrPrefix: "10", sFieldIndex: "6", unit: "", joinCode: "" },
    ...
    { sFieldTitle: "车载行车记录仪", sType: "fieldPara", sPid: "1044", sTrPrefix: "10", sFieldIndex: "19", unit: "", joinCode: "" },
